...
classifierList.each { classifier ->
    def tf = new File (targetDirectory, "environment-specific-filtering-test-" + projectVersion + "-" + classifier + ".jar")
    ...
    def contentOfFirstPropertiesFileFromArchive = t.getLinesFromFileWithinTheArchive(tf, 'common.properties')

    println 'Contents of common.properties: ' + contentOfFirstPropertiesFileFromArchive

    def foundKeyValuePair = classifier in contentOfFirstPropertiesFileFromArchive 
